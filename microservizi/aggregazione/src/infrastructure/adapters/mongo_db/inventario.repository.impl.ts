...
import { InventoryDocument, CloudInventoryMongo } from '../../schemas/inventario.schema';
...
export class InventoryRepositoryMongo implements InventoryRepository{
  constructor(
    @InjectModel(CloudInventoryMongo.name) private readonly inventoryModel: Model<InventoryDocument>
  ) {}
